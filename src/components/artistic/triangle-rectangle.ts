...
@customElement('artistic-triangle-rectangle')
export class ArtisticTriangleRectangle extends LitElement {
  static styles = css`
    div {
      width: 0;
      height: 0;
...
declare global {
  interface HTMLElementTagNameMap {
    'artistic-triangle-rectangle': ArtisticTriangleRectangle;
  }
}
